...
* The original package name 'net.coolblossom.sample.saml.sample-saml-sp' is invalid and this project uses 'net.coolblossom.sample.saml.samplesamlsp' instead.
